...
public class Config
{
    ...
    /**
     * Ratio of reachableEndpoints/totalEndpoints that would allow a quarantined node to reset itself.
     */
    public volatile double reachable_endpoints_ratio_threshold = 0.5;
