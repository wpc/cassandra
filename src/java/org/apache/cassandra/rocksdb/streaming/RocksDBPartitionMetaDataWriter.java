...
public class RocksDBPartitionMetaDataWriter implements RocksDBDataWriter
{
    private final int shardId;
    private final RocksDBCF rocksDBCF;

    public RocksDBPartitionMetaDataWriter(UUID cfId, int shardId)
    {
        rocksDBCF = RocksDBEngine.getRocksDBCF(cfId);
        this.shardId = shardId;
    }

    public void write(byte[] key, byte[] value) throws RocksDBException
    {
        rocksDBCF.applyRawPartitionMetaData(shardId, key, value);
    }
}
