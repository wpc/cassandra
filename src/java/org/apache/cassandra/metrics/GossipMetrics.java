...
{
    private static final MetricNameFactory factory = new DefaultNameFactory("gossipstate");
    public static final Counter unreachableQuarantineDisabled = Metrics.counter(factory.createMetricName("UnreachableQuarantineDisabled"));
    public static final Counter unreachableQuarantineInitial = Metrics.counter(factory.createMetricName("UnreachableQuarantineInitial"));
